...
- [ ] Fix worker executor tests failing because `MontyExecutable` points to `C:\Users\user\Desktop\monty\dist\monty.exe` while this repo contains `executor-rs\dist\monty.exe`.
